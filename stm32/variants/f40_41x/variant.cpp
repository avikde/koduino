...
PinInfo PIN_MAP[] = {
  {GPIOC, 7, NOT_SET, NOT_SET, TIMER8, 2, NOT_SET, NOT_SET},
  {GPIOC, 6, NOT_SET, NOT_SET, TIMER8, 1, NOT_SET, NOT_SET},
  {GPIOC, 8, NOT_SET, NOT_SET, TIMER8, 3, NOT_SET, NOT_SET},
  {GPIOB, 8, NOT_SET, NOT_SET, TIMER4, 4, NOT_SET, NOT_SET},
  {GPIOB, 9, NOT_SET, NOT_SET, TIMER4, 3, NOT_SET, NOT_SET},
  {GPIOC, 9, NOT_SET, NOT_SET, TIMER8, 4, NOT_SET, NOT_SET},
  ...
  {GPIOA, 3, 3, NOT_SET, TIMER5, 4, NOT_SET, NOT_SET},
  {GPIOA, 2, 2, NOT_SET, TIMER5, 3, NOT_SET, NOT_SET},
  {GPIOA, 7, 7, NOT_SET, TIMER3, 2, NOT_SET, NOT_SET},
  {GPIOA, 6, 6, NOT_SET, TIMER3, 1, NOT_SET, NOT_SET},
  {GPIOA, 5, 5, NOT_SET, TIMER2, 1, NOT_SET, NOT_SET},
  {GPIOA, 0, 0, NOT_SET, TIMER5, 1, NOT_SET, NOT_SET},
  {GPIOA, 1, 1, NOT_SET, TIMER5, 2, NOT_SET, NOT_SET},
  {GPIOB, 0, 8, NOT_SET, TIMER3, 3, NOT_SET, NOT_SET},
  {GPIOB, 1, 9, NOT_SET, TIMER3, 4, NOT_SET, NOT_SET},
  {GPIOB, 7, NOT_SET, NOT_SET, TIMER4, 2, NOT_SET, NOT_SET},
  {GPIOB, 6, NOT_SET, NOT_SET, TIMER4, 1, NOT_SET, NOT_SET},
  ...
  {GPIOA, 9, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},
  {GPIOA, 10, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},
  {GPIOA, 8, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},
  {GPIOA, 11, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},
  ...
  {GPIOB, 4, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},
  {GPIOB, 5, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},
  {GPIOB, 10, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},
  {GPIOB, 11, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},
  ...
  {GPIOC, 3, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},
  ...
  // ^^^ Manually delete the last comma at the end ^^^
};
