...
// Constant pin info
PinInfo PIN_MAP[] = {
  {GPIOA, 0, 0, 2, TIMER5, 1, NOT_SET, NOT_SET},//0
  {GPIOA, 1, 1, 1, TIMER2, 2, NOT_SET, NOT_SET},//1
  {GPIOA, 2, 2, 2, TIMER5, 3, NOT_SET, NOT_SET},//2
  {GPIOA, 3, 3, 2, TIMER5, 4, NOT_SET, NOT_SET},//3
  {GPIOA, 4, 4, 0, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//4
  {GPIOA, 5, 5, 1, TIMER2, 1, NOT_SET, NOT_SET},//5
  {GPIOA, 6, 6, 2, TIMER3, 1, NOT_SET, NOT_SET},//6
  {GPIOA, 8, NOT_SET, 0, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//7 SPI2_SCK@5
  {GPIOA, 9, NOT_SET, 7, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//8 USART1_TX
  {GPIOA, 10, NOT_SET, 7, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//9 USART1_RX
  {GPIOA, 11, NOT_SET, 2, TIMER5, 2, NOT_SET, NOT_SET},//10
  {GPIOA, 12, NOT_SET, 6, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//11 SPI_SCK
  {GPIOA, 13, NOT_SET, 6, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//12 SPI1_MISO
  {GPIOA, 14, NOT_SET, 10, TIMER12, 1, NOT_SET, NOT_SET},//13 I2C1_SDA@4
  {GPIOA, 15, NOT_SET, 10, TIMER12, 2, NOT_SET, NOT_SET},//14 I2C1_SCL@4
  
  {GPIOB, 0, 8, 2, TIMER3, 3, NOT_SET, NOT_SET},//15
  {GPIOB, 1, 9, 2, TIMER3, 4, NOT_SET, NOT_SET},//16
  {GPIOB, 2, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//17
  {GPIOB, 3, NOT_SET, 7, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//18 USART2_TX
  {GPIOB, 4, NOT_SET, 7, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//19 USART2_RX
  {GPIOB, 5, NOT_SET, 2, TIMER3, 2, NOT_SET, NOT_SET},//20
  {GPIOB, 6, NOT_SET, 2, TIMER4, 1, NOT_SET, NOT_SET},//21
  {GPIOB, 7, NOT_SET, 2, TIMER4, 2, NOT_SET, NOT_SET},//22
  {GPIOB, 8, NOT_SET, 2, TIMER4, 3, NOT_SET, NOT_SET},//23 USART3_TX@7
  {GPIOB, 9, NOT_SET, 2, TIMER4, 4, NOT_SET, NOT_SET},//24 USART3_RX@7
  {GPIOB, 14, NOT_SET, 1, TIMER15, 1, NOT_SET, NOT_SET},//25 SPI2_MISO@5
  {GPIOB, 15, NOT_SET, 1, TIMER15, 2, NOT_SET, NOT_SET},//26 SPI2_MOSI@5
  
  {GPIOC, 13, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//27
  {GPIOC, 14, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//28
  {GPIOC, 15, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//29
  
  {GPIOD, 8, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET, NOT_SET},//30
