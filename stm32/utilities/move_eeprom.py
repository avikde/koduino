...
# http://www.python.org/doc/2.5.2/lib/module-getopt.html
  ...
  try:
    opts, args = getopt.getopt(sys.argv[1:], "hqVp:b:E:L:y:")
  ...
  try:
    ...
    eepdata = cmd.readMemory(0x08010000, 0x4000*2)
    cmd.cmdExtendedEraseMemory(sectors = (1,2))
    cmd.writeMemory(0x08004000, eepdata)
